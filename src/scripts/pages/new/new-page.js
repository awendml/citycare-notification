...
export default class NewPage {
        ...
        <div class="new-report__header">
          <div class="container">
            ...
            <p class="new-report__header__description">
              Silakan lengkapi formulir di bawah untuk membuat  baru.<br>
              Pastikan  yang dibuat adalah valid.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            ...
            <div class="form-control">
              ...
              <div id="documentations-more-info">Anda dapat menyertakan foto.</div>
            ...
            <div class="form-control">
              ...
              <div class="new-form__location__container">
                ...
                <div class="new-form__location__lat-lng">
                  <input type="text" name="lat" value="-6.175389" disabled>
                  <input type="text" name="lon" value="106.827139" disabled>
                </div>
              </div>
            </div>
  ...
  this.#form.addEventListener('submit', async (event) => {
    ...
    // Ambil blob dari camera
    const pictureBlob = await this.#camera.takePicture();

    const formData = new FormData();
    formData.append('description', description);
    formData.append('lat', lat);
    formData.append('lon', lon);
    formData.append('photo', pictureBlob, 'image.png'); // gunakan nama file opsional

    console.log('formData siap dikirim', formData);

    await this.#presenter.postNewReport(formData);
  });
  ...
  showSubmitLoadingButton() {
    document.getElementById('submit-button-container').innerHTML = `
      <button class="btn" type="submit" disabled>
        <i class="fas fa-spinner loader-button"></i> Buat 
      </button>
    `;
  }
